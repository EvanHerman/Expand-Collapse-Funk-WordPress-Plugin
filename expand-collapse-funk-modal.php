...
.expand-content-link:before { font-family: "ecf-icons"; content: "\e600  ";  font-size:16px; }
			...
			var imageCheckboxValue = jQuery('#includeMediaCheckbox').val();
				...
				if ( inputExpansionLink == '' && inputHiddenContent == '' ) {
					...
					if (jQuery('input#includeMediaCheckbox').prop('checked') == false ) {
						var expandCollapseContent = '<pre><div class="exp-col-content-holder"><a class="expand-content-link" href="#">'+inputExpansionLink+'</a><div class="hidden-content"><p class="hiddenContentp">'+inputHiddenContent+'</p><br style="clear: both;"></div></div></pre><br />';
						...
						var expandCollapseContent = '<pre><div class="exp-col-content-holder"><a class="expand-content-link" href="#">'+inputExpansionLink+'</a><div class="hidden-content"><img src='+inputHiddenContentImage+' /><p class="hiddenContentp">'+inputHiddenContent+'</p><br style="clear: both;"></div></div></pre><br />';
						}
						...
						if (youtubeVideoURLlength == '') {
							...
							var expandCollapseContent = '<pre><div class="exp-col-content-holder"><a class="expand-content-link" href="#">'+inputExpansionLink+'</a><div class="hidden-content"><code><div class="videoWrapper"><iframe src="'+fixedYouTubeURL+'" frameborder="0" allowfullscreen></iframe></div></code><br />'+inputHiddenContent+'</p><br style="clear: both;"></div></div></pre><br />';
						}
					}
...
<?php
	...
	echo '<div class="exp-col-content-holder"><a class="expand-content-link" href="#">Expand/Collapse Plain Text</a><div class="hidden-content">This is all of your hidden content. Anything in this section will be hidden by default. Clicking the expansion link will display all of the hidden content.</div></div>';
